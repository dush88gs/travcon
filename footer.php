...
?>
    ...
    <div class="container-fluid">
      <div class="row payment-methods-bg">
        <div class="col-md-12">
          <div class="copyright">
            <div class="visa-master">
              <span>we accept these payment methods</span>
              <img class="visa-img" src="<?php echo get_bloginfo('template_directory'); ?>/assets/img/travcon/logo-visa.jpg" width="auto" height="50" alt="visa logo">
              <img src="<?php echo get_bloginfo('template_directory'); ?>/assets/img/travcon/logo-mastercard.jpg" width="auto" height="50" alt="mastercard logo">
            </div>
          </div>
        </div>
      </div>
