...
$(function() {
	...
	/* 06 - MENU */
	/*==============================*/
	$("nav.menu .fa-angle-down, nav.menu .fa-chevron-right").on(
    "click",
    function() {
      $(this)
        .parent("a")
...
/***********************************/
    ...
    $(document).ready(function () {
      $('.select-by-holiday-type').select2({
        minimumResultsForSearch: -1,
        dropdownCssClass: 'no-search',
        placeholder: "Select holiday type",
        allowClear: true
      });
      $('.select-by-month').select2({
        minimumResultsForSearch: -1,
        dropdownCssClass: 'no-search',
      ...
      /* Member Equal Height */
      $('.equal-member').matchHeight();

      $('.equal-column').matchHeight();
      
      $('.gridder.destination-gridder').gridderExpander({
        scroll: true,
        scrollOffset: 400,
      ...
      $('.gridder.team-gridder').gridderExpander({
        scroll: true,
        scrollOffset: 425,
        scrollTo: "panel", // panel or listitem
        animationSpeed: 500,
      ...
      if ($('#formModal').exists()) {
        $('#formModal').on('shown.bs.modal', function() {
          // Date Range Picker
          var tlcToday = moment(new Date()).format('YYYY-MM-DD');
          
          $('#tour-duration').dateRangePicker({
            autoClose: true,
            format: 'YYYY-MM-DD',
            separator: ' to ',
            startDate: tlcToday
